...
public class NettyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        try {
            ...
            RpcResponse messageFromServer = RpcResponse.success("RpcResponse");
            messageFromServer.setMessage("message from server");
            ChannelFuture f = ctx.writeAndFlush(messageFromServer);
            System.out.println("channelRead:"+messageFromServer);
